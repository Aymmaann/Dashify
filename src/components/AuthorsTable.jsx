  ...
  return (
    <table class="w-full text-left mt-6">
        <thead>
            ...
            <th class="pr-6 pt-3 pb-2.5">Author</th>
            <th class="px-4 py-2">Function</th>
            <th class="px-4 py-2">Status</th>
            <th class="px-4 py-2">Employed</th>
            <th class="px-4 py-2">Action</th>
            </tr>
        </thead>
        <tbody>
            <tr className='border-t border-slate-700'>
                <td class="pr-4 py-4 flex items-center gap-3">
                ...
                <td class="px-4 py-3 text-sm font-semibold">23/04/24</td>
                <td class="px-4 py-3 text-gray-500 text-sm font-semibold">Edit</td>
            </tr>
            ...
            <tr className='border-t border-slate-700'>
                ...
                <td class="px-4 py-3 text-sm font-semibold">11/01/24</td>
                <td class="px-4 py-3 text-gray-500 text-sm font-semibold">Edit</td>
            </tr>
            ...
            <tr className='border-t border-slate-700'>
                ...
                <td class="px-4 py-3 text-sm font-semibold">19/09/23</td>
                <td class="px-4 py-3 text-gray-500 text-sm font-semibold">Edit</td>
            </tr>
            ...
            <tr className='border-t border-slate-700'>
                ...
                <td class="px-4 py-3 text-sm font-semibold">24/12/22</td>
                <td class="px-4 py-3 text-gray-500 text-sm font-semibold">Edit</td>
            </tr>
            ...
            <tr className='border-t border-slate-700'>
                ...
                <td class="px-4 py-3 text-sm font-semibold">04/10/22</td>
                <td class="px-4 py-3 text-gray-500 text-sm font-semibold">Edit</td>
            </tr>

            <tr className='border-t border-slate-700'>
                <td class="pr-4 pt-4 flex items-center gap-3">
